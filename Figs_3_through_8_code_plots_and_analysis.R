...
ZOI_data <- read_xlsx("S1_File_Supplementary_Figures_Tables_Data.xlsx",sheet = "Raw_data")
...
#stratify by treatment for Figs 4 through 8:
...
###############################
#correlation btwn plate dose and zoi (Fig 8)
